...
import '../../../offers/data/offers_products_remote_datasource.dart';
import '../../data/banners/fetch_banners_remote_datasource.dart';

abstract class AllOffersController extends SearchMixController {
  fetchOffers();
...
class AllOffersControllerImpl extends AllOffersController {
