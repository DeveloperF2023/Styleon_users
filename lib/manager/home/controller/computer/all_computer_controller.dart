...
import 'package:shop/manager/home/controller/computer/search/search_computer_controller.dart';
...
import '../../data/all_computer/all_computer_products_remote_datasource.dart';
import '../../data/banners/fetch_banners_remote_datasource.dart';

abstract class AllComputerController extends SearchComputerController {
  fetchComputer();
...
class AllComputerControllerImpl extends AllComputerController {
  AllComputerProductsRemoteDataSource allComputerProductsRemoteDataSource =
      AllComputerProductsRemoteDataSource(Get.find());
  ...
  fetchComputer() async {
    ...
    var response =
        await allComputerProductsRemoteDataSource.allComputerProducts();
    ...
    if (StatusRequest.success == statusRequest) {
      if (response['status'] == "success") {
        ...
        computers.addAll(responseData.map((e) => ProductModel.fromJson(e)));
      } else {
  ...
  @override
  void onInit() {
    searchComputerController = TextEditingController();
